  ...
  const contacts = [
    {
      ...
      title: "Address",
      value:
        "South PrimeOne School, Harjosari II, Kec. Medan Amplas, Kota Medan, Sumatera Utara",
      action: "Open Maps",
    ...
    <div className="min-h-screen bg-mocha-base text-mocha-text pt-24 pb-16 font-space page-grid-bg">
      <div className="container mx-auto px-6 max-w-5xl">
        ...
        <div className="grid gap-8 md:grid-cols-2 mb-16">
          {contacts.map((contact, index) => (
            ...
            >
              ...
              <h3
                className={`mb-2 text-2xl font-bold text-mocha-text transition-colors ${contact.color}`}
              >
                {contact.title}
              </h3>
        ...
        <div className="mx-auto max-w-2xl">
          ...
          >
            <h2 className="text-3xl font-bold mb-6 text-center text-mocha-mauve">
              Send us Feedback
            </h2>
