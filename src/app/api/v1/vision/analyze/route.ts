...
export async function POST(request: Request) {
  try {
    ...
    const prompt =
      "Analyze this image and explain the academic concept or solve the problem shown. Be helpful and clear. Please use english unless asked in another language, CRITICAL: Never speak more than 3 sentences. Keep responses brief, As vercel will cut off the connection if its too long and never use md syntax like $$ or ** or any others as this will be converted to speech" +
