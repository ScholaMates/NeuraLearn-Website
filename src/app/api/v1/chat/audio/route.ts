...
export async function POST(request: Request) {
  ...
  try {
    ...
    let systemInstruction =
      ...
      "Please use english unless asked in another language, CRITICAL: Never speak more than 3 sentences. Keep responses brief, As vercel will cut off the connection if its too long and never use md syntax like $$ or ** or any others as this will be converted to speech";
