...
export async function POST(request: Request) {
  ...
  try {
    ...
    let systemInstruction =
      ...
      "Use LaTeX for mathematical expressions. Please use english unless asked in another language, Maximum of 2 paragraphs per answer, As vercel will cut off the connection if its too long";
