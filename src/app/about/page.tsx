...
export default function About() {
  ...
  useEffect(() => {
    ...
    if (headlineRef.current && textRef.current) {
      animate([headlineRef.current, textRef.current], {
        translateY: [20, 0],
        opacity: [0, 1],
        delay: stagger(200),
        duration: 800,
    ...
    <div className="min-h-screen bg-mocha-base text-mocha-text pt-24 pb-16 font-space page-grid-bg">
      <div className="container mx-auto px-6">
        ...
        <section className="container mx-auto max-w-4xl text-center mb-32">
          <h1
            ref={headlineRef}
            className="mb-8 text-5xl font-extrabold tracking-tight text-mocha-text sm:text-6xl opacity-0"
          >
            <span className="drop-shadow-[0_0_15px_rgba(203,166,247,0.5)]">
              Our Mission
            </span>
          </h1>
          <p
            ref={textRef}
            className="text-xl leading-relaxed text-mocha-subtext0 drop-shadow-md opacity-0"
          >
            At NeuraLearn, we believe that{" "}
            <span className="text-mocha-blue font-semibold">
              focus is the new superpower
            </span>
            . Our mission is to empower students with intelligent,
            distraction-free tools that foster deep learning and academic
            growth. We are building a future where technology amplifies human
            potential without demanding constant attention.
          </p>
        </section>
        ...
        <section className="container mx-auto max-w-6xl">
          <h2
            ref={teamTitleRef}
            className="mb-16 text-center text-4xl font-bold text-mocha-text drop-shadow-[0_0_10px_rgba(137,180,250,0.5)] opacity-0"
          >
            Meet the Team
          </h2>
              ...
              >
                ...
                <div className="flex flex-1 flex-col justify-between p-6 sm:p-8">
                  ...
                  <div className="rounded-lg bg-mocha-surface1/30 px-4 py-3 text-sm">
                    <span className="font-bold text-mocha-text mr-2">
                      Specialty:
                    </span>
