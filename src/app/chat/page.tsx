      ...
      >
        <div className={`${!sidebarOpen && "md:hidden"} flex flex-col h-full`}>
          ...
          <div className="flex-1 overflow-y-auto scrollbar-thin scrollbar-thumb-mocha-surface2">
            <div className="text-xs font-semibold text-mocha-overlay1 uppercase mb-2 ml-2">
              History
            </div>
            {chats.length === 0 ? (
              <div className="text-sm text-mocha-overlay0 ml-2 italic">
                No previous chats
              </div>
            ) : (
              chats.map((chat) => (
                <div
                  key={chat.id}
                  className={`group flex items-center justify-between w-full px-3 py-2 rounded-md transition-colors mb-1 ${
                          ...
                          components={{
                            ...
                            code: ({
                              ...
                              return match ? (
                                ...
                                <code
                                  className="bg-mocha-surface2 px-1 py-0.5 rounded text-sm"
                                  {...props}
                                >
                                  {children}
                                </code>
