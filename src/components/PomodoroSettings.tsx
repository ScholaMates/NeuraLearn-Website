    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
      <div className="w-full max-w-md bg-mocha-base border border-mocha-surface1 rounded-2xl p-6 shadow-2xl">
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-xl font-bold text-mocha-text font-space">
            Timer Settings
          </h2>
          <button
            onClick={onClose}
            className="text-mocha-subtext0 hover:text-mocha-text"
        ...
        <div className="space-y-6">
          <div className="space-y-2">
            <label
              ...
              className="text-sm font-medium text-mocha-subtext0"
            >
