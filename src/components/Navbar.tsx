  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 border-b border-mocha-surface1 bg-mocha-base/80 backdrop-blur-md font-space">
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <Link
          href="/"
          className="flex items-center gap-2 text-xl font-bold text-mocha-text hover:text-mocha-mauve transition-colors"
        >
        ...
        <div className="hidden md:flex items-center gap-6">
          <Link
            href="/"
            className={`text-sm font-medium transition-colors hover:text-mocha-mauve ${
              pathname === "/" ? "text-mocha-mauve" : "text-mocha-subtext0"
            } `}
          >
            Home
          </Link>
          <Link
            href="/about"
            className={`text-sm font-medium transition-colors hover:text-mocha-mauve ${
              pathname === "/about" ? "text-mocha-mauve" : "text-mocha-subtext0"
            } `}
          >
            About
          </Link>
        ...
        <div className="md:hidden border-t border-mocha-surface1 bg-mocha-base">
          <div className="space-y-1 px-4 pb-4 pt-2">
            <Link
              ...
              className={`block w-full rounded-md px-3 py-2 text-base font-medium hover:bg-mocha-surface1 ${
                pathname === "/"
